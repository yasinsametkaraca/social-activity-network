...
def low_file_directory_path(self, filename):
    ...
    fn = uuid.uuid4()
    return 'profile_files/photos_{0}/low/{1}_{2}.{3}'.format(username, user_id, fn, ext)
...
class Profile(models.Model):
    ...
    following = models.ManyToManyField(AUTH_USER_MODEL, related_name="following", blank=True)
    follower = models.ManyToManyField(AUTH_USER_MODEL, related_name='follower', blank=True)
