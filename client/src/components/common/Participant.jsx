...
const Participant = ({
    ...
    const participantAcceptOrReject = async (status) => {
        try {
    ...
    return (
        <div className={`relative mt-1`}>
            {((participant.participate_status === "Accepted") & (user.username !== post.owner)) ?
                                    ...
                                    <div
                                        ...
                                        >
                                            <li
                                                ...
                                                onClick={() => participantAcceptOrReject("Accepted")}>
                                            ...
                                            <li
                                                ...
                                                onClick={() => participantAcceptOrReject("Rejected")}>
